...
export const getRestaurantById = (reqData) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: GET_RESTAURANT_BY_ID_FAILURE, payload: e})
        }
    }
}
...
export const getRestaurantByUserId = (jwt) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: GET_RESTAURANT_BY_USER_ID_FAILURE, payload: e})
        }
    }
}
...
export const createRestaurant = (reqData) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: CREATE_RESTAURANT_FAILURE, payload: e})
        }
    }
}
...
export const updateRestaurant = ({restaurantId, restaurantData, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: UPDATE_RESTAURANT_FAILURE, payload: e})
        }
    }
}
...
export const deleteRestaurant = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: DELETE_RESTAURANT_FAILURE, payload: e})
        }
    }
}
...
export const updateRestaurantStatus = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: UPDATE_RESTAURANT_STATUS_FAILURE, payload: e})
        }
    }
}
...
export const createEvent = ({data, jwt, restaurantId}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: CREATE_EVENTS_FAILURE, payload: e})
        }
    }
}
...
export const getRestaurantCategory = ({ jwt, restaurantId }) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: GET_RESTAURANTS_CATEGORY_FAILURE, payload: e})
        }
    }
}
